...
class TestAddressDAO:
    ...
    def test_get_address_by_id_exists(self, address_dao, clean_database):
        ...
        assert retrieved_address.address_street == "Contour Antoine de Saint-Exupéry"
    ...
    def test_get_address_by_customer_id(self, address_dao, customer_dao, clean_database):
        ...
        address = address_dao.create_address(
            number=95, street="Rue Papu", city="Rennes", postal_code=35000, country="France"
        )
    ...
    def test_update_address_single_field(self, address_dao, clean_database):
        ...
        created_address = address_dao.create_address(
            number=1, street="Rue Test", city="Rennes", postal_code=35000, country="France"
        )
        ...
        assert updated_address.address_city == "Rennes"
        assert updated_address.address_number == 1
    ...
    def test_delete_address(self, address_dao, clean_database):
        ...
        created_address = address_dao.create_address(
            number=1, street="Rue à supprimer", city="Test", postal_code=35000, country="France"
        )
